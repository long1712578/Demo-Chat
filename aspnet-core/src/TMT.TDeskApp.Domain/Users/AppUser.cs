...
namespace TMT.TDeskApp.Users
{
     ...
     */
    public class AppUser : FullAuditedAggregateRoot<string>, ITMTMultiTenant
    {
         ...
         *
         * 1. Update TDeskAppDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TDeskAppEfCoreEntityExtensionMappings to extend the IdentityUser entity
