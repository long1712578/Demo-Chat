...
{
    public class TMTTenantDataSeedContext
    {
        ...
        public TMTTenantDataSeedContext(string tenantId = null)
        {
            TenantId = tenantId;
        ...
        /// </summary>
        public virtual TMTTenantDataSeedContext WithProperty(string key, object value)
        {
